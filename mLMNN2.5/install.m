...
comperror=comperror || compile('count.cpp',force);
comperror=comperror || compile('sd.cpp',force);
comperror=comperror || compile('SODd.cpp',force);
comperror=comperror || compile('sumiflessh2.cpp',force);
comperror=comperror || compile('sumiflessv2.cpp',force);
comperror=comperror || compile('mink.cpp',force);
comperror=comperror || compile('minkomp.cpp',force);
comperror=comperror || compile('cdist.cpp',force);
comperror=comperror || compile('cdistomp.cpp',force);
comperror=comperror || compile('SODW.cpp',force);
